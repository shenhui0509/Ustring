...
noexcept {
  ...
  return boyer_moore_internal(text, pattern, false) != 0;
}
...
size_t PatternSearcher::boyer_moore_internal(const string &text, const string &pattern, bool find)
{
  ...
  return find ? string::npos : result;
}
}//namespace ustr
